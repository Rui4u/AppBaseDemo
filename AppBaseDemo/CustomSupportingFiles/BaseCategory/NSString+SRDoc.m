...
+ (NSString *)insertPermilWithStr:(NSString *)perStr
{
    ...
    if ([perStr containsString:@","]) {
        return perStr;
    }else  {
        
        NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
        [formatter setPositiveFormat:@"###,##0.00;"];
        NSString *string = [formatter stringFromNumber:[NSNumber numberWithDouble:[perStr doubleValue]]]; 
        return string;
    }
}
...
{
    NSArray *perArray = [perStr componentsSeparatedByString:@","];
    
    NSMutableString *newPer = [[NSMutableString alloc] init];
    
    for (NSString *str in perArray) {
        
        [newPer appendString:str];
    }
    
    NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
    formatter.numberStyle = NSNumberFormatterNoStyle;
    NSString *string = [formatter stringFromNumber:[NSNumber numberWithDouble:[newPer doubleValue]]];
    return string;
}
